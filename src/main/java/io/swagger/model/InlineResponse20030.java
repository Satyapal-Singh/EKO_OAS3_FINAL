...
public class InlineResponse20030   {
  ...
  public InlineResponse20030 message(String message) {
  ...
  public InlineResponse20030 responseTypeId(Integer responseTypeId) {
  ...
  public InlineResponse20030 responseStatusId(Integer responseStatusId) {
  ...
  public InlineResponse20030 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  public InlineResponse20030 data(Object data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.message, inlineResponse20030.message) &&
        Objects.equals(this.responseTypeId, inlineResponse20030.responseTypeId) &&
        Objects.equals(this.responseStatusId, inlineResponse20030.responseStatusId) &&
        Objects.equals(this.status, inlineResponse20030.status) &&
