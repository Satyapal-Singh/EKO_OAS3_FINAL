...
public class InlineResponse500   {
  ...
  public InlineResponse500 statusDesc(String statusDesc) {
  ...
  public InlineResponse500 responseCode(String responseCode) {
  ...
  public InlineResponse500 responseCodeDesc(String responseCodeDesc) {
  ...
  public InlineResponse500 responseStatusId(Integer responseStatusId) {
  ...
  public InlineResponse500 error(Object error) {
    this.error = error;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.status, inlineResponse500.status) &&
        Objects.equals(this.statusDesc, inlineResponse500.statusDesc) &&
        Objects.equals(this.responseCode, inlineResponse500.responseCode) &&
        Objects.equals(this.responseCodeDesc, inlineResponse500.responseCodeDesc) &&
        Objects.equals(this.responseStatusId, inlineResponse500.responseStatusId) &&
        Objects.equals(this.error, inlineResponse500.error);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, statusDesc, responseCode, responseCodeDesc, responseStatusId, error);
  }
